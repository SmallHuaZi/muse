#ifndef LIB_ENUMBITS_ENUMBITS_HPP
#define LIB_ENUMBITS_ENUMBITS_HPP
...
#define MUSE_ENABLE_ENUMBITS(T)    \
    static auto muse_enable_enumbits(T) -> int;\

#define MUSE_ENABLE_INNER_ENUMBITS(T)    \
...
#endif // LIB_ENUMBITS_ENUMBITS_HPP
